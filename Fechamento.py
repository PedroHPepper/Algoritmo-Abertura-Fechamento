...
imagemResultante = transforma.dilatação(imgbinaria)
imagemResultante2 = transforma.erosão(imagemResultante)
...
plt.subplot(1,4,3), plt.imshow(imagemResultante,"gray", vmin=0, vmax=1), plt.title('Imagem Resultante Dilatação'), plt.xticks([]), plt.yticks([])
plt.subplot(1,4,4), plt.imshow(imagemResultante2,"gray", vmin=0, vmax=1), plt.title('Imagem Resultante Fechamento'), plt.xticks([]), plt.yticks([])
plt.show()
